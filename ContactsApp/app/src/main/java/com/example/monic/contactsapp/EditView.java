...
public class EditView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Contact c = (Contact) getIntent().getExtras().getSerializable("contactDetails");
        ...
        findViewById(R.id.imageView2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {// Here, thisActivity is the current activity
                if (ContextCompat.checkSelfPermission(EditView.this, Manifest.permission.CAMERA)
                        != PackageManager.PERMISSION_GRANTED) {

                    ActivityCompat.requestPermissions(EditView.this,
        ...
        imageView.setImageURI(c.getImageURI());
        fname.setText(c.firstName);
        lname.setText(c.lastName);
        phonenum.setText(c.phoneNumber);
        comname.setText(c.company);
        email.setText(c.emailID);
        url.setText(c.urlName);
        address.setText(c.localAddress);
        birthday.setText(c.birthDate);
        nickname.setText(c.nickName);
        fburl.setText(c.fbUrl);
        twitter.setText(c.twitterUrl);
        skype.setText(c.skypeId);
        ...
        final DatePickerDialog dpdialog = new DatePickerDialog(EditView.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
        ...
        birthday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dpdialog.show();
//                new DatePickerDialog(EditView.this, date,
...
//                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bDate != null && bDate.before(dateToCompare)) {
                    Toast.makeText(EditView.this, "Birthdate should not be before Jan 1, 1850", Toast.LENGTH_LONG).show();
                } else if (firstName.equals("") || lastName.equals("") || phoneNumber.equals("")) {
                    Toast.makeText(EditView.this, "First, Last Name & Phone Number are mandatory fields. Please Enter.", Toast.LENGTH_LONG).show();
                } else if (!(matcher.matches())) {
                    Toast.makeText(EditView.this, "Invalid phone number.", Toast.LENGTH_LONG).show();
                } else if (!(emailId.equals("")) && !(emailId.matches(emailPattern))) {
                    Toast.makeText(EditView.this, "Invalid Email ID.", Toast.LENGTH_LONG).show();
                } else {

                    Log.d("editcontact","helloo");
                    ...
                    intent.putExtra(ContactListView.CONTACT_ADD, contact);
    ...
    public Uri getImageUri(Context inContext, Bitmap inImage) {
        ...
        if (ContextCompat.checkSelfPermission(EditView.this,
